...
class PurchaseModel: ObservableObject {
    ...
    init() {
        ...
        self.productDetails = [
            PurchaseProductDetails(price: "$49.99", productId: "lifetimeplan", duration: "lifetime", durationPlanName: "Lifetime Plan", hasTrial: false),
            PurchaseProductDetails(price: "$4.99", productId: "weekly_399", duration: "week", durationPlanName: "Weekly Plan", hasTrial: true)
        ]
    ...
    func fetchProducts() async {
        ...
        do {
            ...
            // Only update prices if we successfully fetched products
            if !products.isEmpty {
                ...
                for product in products {
                    ...
                    let planName = product.id == "lifetimeplan" ? "Lifetime Plan" : "Weekly Plan"
            ...
            // If no products found, keep the demo prices for template preview
            isFetchingProducts = false
            
        } catch {
            print("Failed to fetch products: \(error)")
            // Keep the demo prices if StoreKit fails
            isFetchingProducts = false
        }
    }
